...
export default function AgentWallet() {
  ...
  const loadAgentData = async () => {
    ...
    try {
      ...
      if (data.wallet_address) {
        (updatedAgent as unknown as { wallet_address: string }).wallet_address = data.wallet_address;
      }
      
      if (data.wallet_type) {
        (updatedAgent as unknown as { wallet_type: string }).wallet_type = data.wallet_type;
      }
  ...
  }, [navigate, toast, agent?.id, loadAgentData]);
              ...
              <div className="space-y-4">
                <div className="flex flex-col">
                  ...
                  <div className="text-3xl font-bold mt-1">
                    {agent ? (agent.balance / (agent.exchange_rate || 10.0)).toFixed(2) : "0.00"}
                  </div>
                </div>
